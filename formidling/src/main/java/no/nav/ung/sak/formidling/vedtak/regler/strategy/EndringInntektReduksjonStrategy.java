...
import no.nav.ung.sak.formidling.innhold.EndringInntektReduksjonInnholdBygger;
...
public final class EndringInntektReduksjonStrategy implements VedtaksbrevInnholdbyggerStrategy {
    ...
    @Inject
    public EndringInntektReduksjonStrategy(EndringInntektReduksjonInnholdBygger endringInntektReduksjonInnholdBygger) {
