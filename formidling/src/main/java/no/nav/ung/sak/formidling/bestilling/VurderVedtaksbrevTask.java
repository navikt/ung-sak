...
public class VurderVedtaksbrevTask extends BehandlingProsessTask {
    ...
    private void validerBrevbestillingForespørsel(Behandling behandling, DokumentMalType dokumentMalType) {
        if (!behandling.erAvsluttet() &&
            !DokumentMalType.KLAGE_OVERSENDT_KLAGEINSTANS.equals(dokumentMalType)) { // Unntak for oversendt til klageinstans, som ikke avslutter behandling før den er ferdig behandlet i kabal
