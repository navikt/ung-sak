...
public final class EndringHøySatsByggerStrategy implements VedtaksbrevInnholdbyggerStrategy {

    private final EndringHøySatsInnholdBygger endringHøySatsInnholdBygger;

    @Inject
    public EndringHøySatsByggerStrategy(EndringHøySatsInnholdBygger endringHøySatsInnholdBygger) {
    ...
    public ByggerResultat evaluer(Behandling behandling, LocalDateTimeline<DetaljertResultat> detaljertResultat) {
        return new ByggerResultat(endringHøySatsInnholdBygger, "Automatisk brev ved endring til høy sats.");
    }
