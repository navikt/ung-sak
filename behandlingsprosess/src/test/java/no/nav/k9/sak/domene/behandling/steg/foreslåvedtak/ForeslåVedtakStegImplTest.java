...
public class ForeslåVedtakStegImplTest {
    ...
    public void skalKalleForeslåVedtakTjeneste() {
        ...
        ForeslåVedtakStegImpl steg = new ForeslåVedtakStegImpl(behandlingRepository, foreslåVedtakTjeneste, formidlingDokumentdataKlient, new UnitTestLookupInstanceImpl<YtelsespesifikkForeslåVedtak>(b -> null), null, null);
