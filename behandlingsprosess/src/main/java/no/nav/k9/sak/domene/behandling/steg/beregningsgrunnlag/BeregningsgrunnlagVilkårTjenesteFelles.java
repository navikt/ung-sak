...
public abstract class BeregningsgrunnlagVilkårTjenesteFelles {
    ...
    protected BeregningsgrunnlagVilkårTjenesteFelles() {
        // CDI Proxy
    }

    @Inject
    public BeregningsgrunnlagVilkårTjenesteFelles(BehandlingRepository behandlingRepository,
    ...
    private VilkårResultatBuilder opprettAvslåttVilkårsResultat(Vilkårene vilkårene,
                                                                DatoIntervallEntitet vilkårsPeriode,
                                                                Avslagsårsak avslagsårsak) {
        VilkårResultatBuilder builder = hentVilkårResultatBuilderFraEksisterende(vilkårene);
        VilkårBuilder vilkårBuilder = hentBuilderForVilkår(builder);
        vilkårBuilder
    ...
    protected VilkårResultatBuilder hentVilkårResultatBuilderFraEksisterende(Vilkårene vilkårene) {
        return Vilkårene.builderFraEksisterende(vilkårene);
    }
