...
public class InnvilgetUttakVurderer implements UttakRegelVurderer {
    ...
    public InnvilgetUttakVurderer(LocalDateTimeline<Boolean> perioderTilVurdering, LocalDateTimeline<Boolean> ungdomsprogramtidslinje, LocalDateTimeline<Boolean> levendeBrukerTidslinje) {
