...
## Nnotification of discrepancy for income control
...
In case there is no (or up to 15 NOK) discrepancy between the income from a-ordningen and the reported income from the applicant, correct income is determined to be the reported income from the applicant and the payment is reduced by 66% of the reported income from the applicant.
