...
import static no.nav.ung.kodeverk.behandling.BehandlingStegType.VURDER_KOMPLETTHET_BOSTEDVILKÅR;

@ApplicationScoped
@BehandlingStegRef(value = VURDER_KOMPLETTHET_BOSTEDVILKÅR)
@BehandlingTypeRef
@FagsakYtelseTypeRef(FagsakYtelseType.AKTIVITETSPENGER)
public class VurderKompletthetBostedvilkårSteg extends VilkårVurderingSteg {
    ...
    @Inject
    public VurderKompletthetBostedvilkårSteg(ManuelleVilkårRekkefølgeTjeneste manuelleVilkårRekkefølgeTjeneste,
