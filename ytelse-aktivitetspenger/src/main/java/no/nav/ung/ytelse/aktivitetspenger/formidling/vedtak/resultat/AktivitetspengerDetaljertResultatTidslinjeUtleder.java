...
public class AktivitetspengerDetaljertResultatTidslinjeUtleder implements DetaljertResultatTidslinjeUtleder {
    ...
    public LocalDateTimeline<DetaljertResultat> utledDetaljertResultat(Behandling behandling) {
        ...
        var perioderTilVurdering = prosessTriggerPeriodeUtleder.utledTidslinje(behandling.getId())
            .mapValue(AktivitetspengerDetaljertResultatTidslinjeUtleder::fjernIkkeRelevanteÅrsaker)
            .combine(tilkjentYtelseTidslinje, AktivitetspengerDetaljertResultatTidslinjeUtleder::fjernIkkeRelevanteKontrollårsaker, JoinStyle.LEFT_JOIN)
            .combine(kontrollertePerioderTidslinje, AktivitetspengerDetaljertResultatTidslinjeUtleder::fjernIkkeRelevanteKontrollårsaker, JoinStyle.LEFT_JOIN)
