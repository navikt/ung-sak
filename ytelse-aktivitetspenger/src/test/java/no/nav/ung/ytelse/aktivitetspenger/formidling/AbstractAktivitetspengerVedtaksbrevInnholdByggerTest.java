...
abstract class AbstractAktivitetspengerVedtaksbrevInnholdByggerTest {
    ...
    protected AktivitetspengerTestRepositories testRepositories;

    @Inject
    protected VedtaksbrevTjeneste vedtaksbrevTjeneste;

    AbstractAktivitetspengerVedtaksbrevInnholdByggerTest(int forventetAntallPdfSider, String forventetPdfHovedoverskrift) {
    ...
    void baseSetup(TestInfo testInfo) {
        ...
        this.fnr = pdl.fnr();
        testRepositories = BrevTestUtils.lagAlleTestRepositories(entityManager);
    }
