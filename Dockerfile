...
FROM ghcr.io/navikt/k9-felles/felles-java-25:12.1.1 AS duplikatfjerner
...
FROM ghcr.io/navikt/k9-felles/felles-java-25:12.1.1
...
#fonter, templates
COPY --link formidling-pdfgen-templates/src/main/resources/pdfgen /app/pdfgen
