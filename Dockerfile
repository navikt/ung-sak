...
ENV JAVA_OPTS="-XX:MaxRAMPercentage=75.0 -XX:ActiveProcessorCount=4 -Djdk.virtualThreadScheduler.parallelism=8 -Djdk.tracePinnedThreads=short -Djava.security.egd=file:/dev/./urandom -Duser.timezone=Europe/Oslo "
