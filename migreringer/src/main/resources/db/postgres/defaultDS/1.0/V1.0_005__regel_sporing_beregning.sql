...
update UNG_SATS_PERIODER set regel_input = lo_from_bytea(0, 'regelinput'::bytea);
update UNG_SATS_PERIODER set regel_sporing = lo_from_bytea(0, 'regelsporing'::bytea);
