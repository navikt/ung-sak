...
--   bosatt_periode_avklaring_foreslatt = foreslått og behandlet i behandlingen som eier holderen
...
create table bosatt_periode_avklaring_foreslatt
(
...
comment on table bosatt_periode_avklaring_foreslatt is 'Bostedsavklaringer som er foreslått og behandlet i behandlingen som eier holderen. Kopieres ikke til nye behandlinger.';

create index idx_bosatt_periode_avkl_foreslatt_holder on bosatt_periode_avklaring_foreslatt (bosatt_avklaring_holder_id);
create index idx_bosatt_periode_avkl_foreslatt_referanse on bosatt_periode_avklaring_foreslatt (referanse);

-- Flytter avklaringer under arbeid over i den nye tabellen. Kun ment for å ikke ødelegge saker i test.
insert into bosatt_periode_avklaring_foreslatt (id, bosatt_avklaring_holder_id, referanse, periode, ikke_oppfylt_aarsak,
