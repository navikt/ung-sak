...
update behandling b set behandling_resultat_type = coalesce((select behandling_resultat_type from behandling_resultat br where br.behandling_id = b.id and br.behandling_resultat_type is not null), 'IKKE_FASTSATT');
