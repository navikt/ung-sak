...
comment on table bosatt_periode_avklaring is 'Aggregatlag mellom bosatt_avklaring_holder og bosatt_avklaring. Holder avklaringer per vilkårsperiode og brukes som referanse i etterlysning og uttalelse.';
...
(
    id                           bigint                                              not null primary key,
    bosatt_periode_avklaring_id  bigint references bosatt_periode_avklaring (id)    not null,
...
comment on table bosatt_avklaring is 'Fakta-avklaring om brukers bosted for én fom-dato. Fom-dato er startdatoen for avklaringsperioden.';

create index idx_bosatt_avklaring_periode on bosatt_avklaring (bosatt_periode_avklaring_id);
...
(
    ...
    soknad_avklaring_holder_id   bigint references bosatt_avklaring_holder (id),
