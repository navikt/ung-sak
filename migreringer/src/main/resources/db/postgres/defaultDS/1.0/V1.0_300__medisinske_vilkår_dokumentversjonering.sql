...
insert into SYKDOM_DOKUMENT_INFORMASJON(SYKDOM_DOKUMENT_ID, VERSJON, TYPE, DATERT, MOTTATT, OPPRETTET_AV, OPPRETTET_TID)
SELECT ID, 0, TYPE, DATERT, MOTTATT, OPPRETTET_AV, OPPRETTET_TID
