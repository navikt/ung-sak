...
update behandling b
set original_behandling_id = x.original_behandling_id
from (select distinct original_behandling_id, behandling_id from behandling_arsak) x
where x.behandling_id = b.id;
...
create index IF NOT EXISTS idx_behandling_7
