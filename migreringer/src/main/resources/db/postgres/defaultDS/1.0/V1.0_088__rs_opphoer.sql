...
(
    ...
    fritekst_vurdering_brev     varchar(4000),
...
comment on table rs_opphoer is 'Resultat for opphør av vilkår per skjæringstidspunkt. Lagrer opphørsdato, opphørsårsak (Avslagsårsak), vilkårtype og kilde.';

create index idx_rs_opphoer_behandling on rs_opphoer (behandling_id);
create unique index uidx_rs_opphoer_aktiv on rs_opphoer (behandling_id, skaeringstidspunkt, vilkar_type) where (aktiv = true);
