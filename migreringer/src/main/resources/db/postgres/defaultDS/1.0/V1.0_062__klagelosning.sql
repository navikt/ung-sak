...
comment on column klage_utredning.paaklagd_behandling_uuid is 'Ref til påklagd behandling';
comment on column klage_utredning.paaklagd_behandling_type is 'Påklagd behandlingtype';
