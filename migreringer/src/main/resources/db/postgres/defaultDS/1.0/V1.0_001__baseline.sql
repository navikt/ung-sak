...
create UNIQUE index PK_PROSESS_TASK on PROSESS_TASK (ID);alter table PROSESS_TASK add constraint PK_PROSESS_TASK primary key using index PK_PROSESS_TASK;
...
alter table FAGSAK_PROSESS_TASK add constraint FK_FAGSAK_PROSESS_TASK_2 foreign key (PROSESS_TASK_ID) references PROSESS_TASK(ID);
