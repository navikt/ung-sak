...
create table if not exists SYKDOM_GRUNNLAG_INNLEGGELSE
(
    ID            BIGINT                                 NOT NULL PRIMARY KEY,
    SYKDOM_GRUNNLAG_ID          BIGINT                      NOT NULL,
    ...
    OPPRETTET_AV  VARCHAR(20)  DEFAULT 'VL'              NOT NULL,
    OPPRETTET_TID TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT FK_SYKDOM_GRUNNLAG_INNLEGGELSE_01
        FOREIGN KEY(SYKDOM_GRUNNLAG_ID) REFERENCES SYKDOM_GRUNNLAG(ID),
    CONSTRAINT FK_SYKDOM_GRUNNLAG_INNLEGGELSE_02
        FOREIGN KEY(SYKDOM_INNLEGGELSE_ID) REFERENCES SYKDOM_INNLEGGELSE(ID)
);
create sequence if not exists SEQ_SYKDOM_GRUNNLAG_INNLEGGELSE increment by 5 minvalue 1000000;
...
create table if not exists SYKDOM_GRUNNLAG_DIAGNOSEKODER
(
    ID            BIGINT                                 NOT NULL PRIMARY KEY,
    SYKDOM_GRUNNLAG_ID          BIGINT                      NOT NULL,
    ...
    OPPRETTET_AV  VARCHAR(20)  DEFAULT 'VL'              NOT NULL,
    OPPRETTET_TID TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT FK_SYKDOM_GRUNNLAG_DIAGNOSEKODER_01
        FOREIGN KEY(SYKDOM_GRUNNLAG_ID) REFERENCES SYKDOM_GRUNNLAG(ID),
    CONSTRAINT FK_SYKDOM_GRUNNLAG_DIAGNOSEKODER_02
        FOREIGN KEY(SYKDOM_DIAGNOSEKODER_ID) REFERENCES SYKDOM_DIAGNOSEKODER(ID)
);
create sequence if not exists SEQ_SYKDOM_GRUNNLAG_DIAGNOSEKODER increment by 5 minvalue 1000000;
