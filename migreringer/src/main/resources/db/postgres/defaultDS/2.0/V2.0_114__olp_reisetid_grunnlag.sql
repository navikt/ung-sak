...
(
    ...
    OPPLAERING_FOM          DATE                                   NOT NULL,
    OPPLAERING_TOM          DATE                                   NOT NULL,
...
create table if not exists OLP_VURDERT_REISETID_PERIODE
(
    ID                      BIGINT                                 NOT NULL PRIMARY KEY,
    VURDERT_REISETID_ID     BIGINT                                 NOT NULL,
    FOM                     DATE                                   NOT NULL,
    TOM                     DATE                                   NOT NULL,
    ...
    ENDRET_AV               VARCHAR(20),
    ENDRET_TID              TIMESTAMP(3),
    constraint FK_OLP_VURDERT_REISETID_PERIODE_1 foreign key (VURDERT_REISETID_ID) references OLP_VURDERT_REISETID
);
create sequence if not exists SEQ_OLP_VURDERT_REISETID_PERIODE increment by 50 minvalue 1000000;
