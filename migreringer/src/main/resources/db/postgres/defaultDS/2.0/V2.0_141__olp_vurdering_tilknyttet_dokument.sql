...
(
    ...
    SOEKERS_BEHANDLING_UUID     UUID                                        NOT NULL,
...
create index IDX_OPPLAERING_DOKUMENT_1 ON OPPLAERING_DOKUMENT (SOEKERS_BEHANDLING_UUID);
...
create unique index UIDX_OLP_VURDERT_OPPLAERING_PERIODE_ANVENDT_DOKUMENT_1 ON OLP_VURDERT_OPPLAERING_PERIODE_ANVENDT_DOKUMENT (VURDERT_OPPLAERING_PERIODE_ID, OPPLAERING_DOKUMENT_ID);
...
create unique index UIDX_OLP_VURDERT_OPPLAERING_ANVENDT_DOKUMENT_1 ON OLP_VURDERT_OPPLAERING_ANVENDT_DOKUMENT (VURDERT_OPPLAERING_ID, OPPLAERING_DOKUMENT_ID);
