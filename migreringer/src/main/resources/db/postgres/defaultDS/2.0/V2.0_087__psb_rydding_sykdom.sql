...
ALTER SEQUENCE seq_sykdom_vurderinger RENAME TO seq_pleietrengende_sykdom;
...
ALTER SEQUENCE seq_sykdom_diagnosekoder RENAME TO seq_pleietrengende_sykdom_diagnoser;
...
ALTER SEQUENCE seq_sykdom_diagnosekode RENAME TO seq_pleietrengende_sykdom_diagnose;
...
ALTER SEQUENCE seq_sykdom_vurdering RENAME TO seq_pleietrengende_sykdom_vurdering;
...
ALTER SEQUENCE seq_sykdom_vurdering_versjon RENAME TO seq_pleietrengende_sykdom_vurdering_versjon;
...
ALTER SEQUENCE seq_sykdom_vurdering_periode RENAME TO seq_pleietrengende_sykdom_vurdering_versjon_periode;
...
ALTER SEQUENCE seq_sykdom_innleggelser RENAME TO seq_pleietrengende_sykdom_innleggelser;
...
ALTER SEQUENCE seq_sykdom_innleggelse_periode RENAME TO seq_pleietrengende_sykdom_innleggelse_periode;
...
ALTER SEQUENCE seq_sykdom_dokument RENAME TO seq_pleietrengende_sykdom_dokument;
...
alter table PLEIETRENGENDE_SYKDOM_DOKUMENT_INFORMASJON add constraint fk_pleietrengende_sykdom_dokument_informasjon_02 foreign key (duplikat_av_pleietrengende_sykdom_dokument_id) references pleietrengende_sykdom_dokument(id);
ALTER SEQUENCE seq_sykdom_dokument_informasjon RENAME TO seq_pleietrengende_sykdom_dokument_informasjon;
...
ALTER SEQUENCE seq_sykdom_grunnlag_behandling RENAME TO seq_gr_medisinsk;
...
ALTER SEQUENCE seq_sykdom_grunnlag RENAME TO seq_medisinsk_grunnlagsdata;
...
drop sequence seq_sykdom_dokument_sak;
drop sequence seq_sykdom_grunnlag_dokument;
drop sequence seq_sykdom_grunnlag_vurdering;
drop sequence seq_sykdom_vurdering_versjon_dokument;
