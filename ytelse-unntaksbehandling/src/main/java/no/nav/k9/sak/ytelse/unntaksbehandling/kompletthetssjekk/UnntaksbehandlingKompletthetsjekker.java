package no.nav.k9.sak.ytelse.unntaksbehandling.kompletthetssjekk;
...
public class UnntaksbehandlingKompletthetsjekker implements Kompletthetsjekker {

    @Inject
    UnntaksbehandlingKompletthetsjekker() {
        // CDI
    }
