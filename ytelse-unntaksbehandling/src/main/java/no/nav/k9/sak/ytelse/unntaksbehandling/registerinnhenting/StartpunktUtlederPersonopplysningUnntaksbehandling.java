...
class StartpunktUtlederPersonopplysningUnntaksbehandling implements StartpunktUtleder {
    ...
    @Inject
    StartpunktUtlederPersonopplysningUnntaksbehandling() {
        // For CDI
    }

    @Override
    public StartpunktType utledStartpunkt(BehandlingReferanse ref, Object grunnlagId1, Object grunnlagId2) {
        FellesStartpunktUtlederLogger.loggEndringSomFørteTilStartpunkt(this.getClass().getSimpleName(), StartpunktType.KONTROLLER_FAKTA, "personopplysning", grunnlagId1, grunnlagId2);
