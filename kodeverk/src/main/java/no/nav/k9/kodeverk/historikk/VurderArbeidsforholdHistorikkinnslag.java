...
public enum VurderArbeidsforholdHistorikkinnslag implements Kodeverdi {
    ...
    @JsonCreator
    public static VurderArbeidsforholdHistorikkinnslag  fraKode(String kode)  {
        if (kode == null) {
            return null;
        }
    ...
    @JsonCreator
    public static VurderArbeidsforholdHistorikkinnslag fraObjektProp(@JsonProperty("kode") String kode) {
        return fraKode(kode);
    }
