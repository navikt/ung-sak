...
public enum BehandlingStegType implements Kodeverdi {
    ...
    VURDER_KOMPLETTHET_BEREGNING("KOMPLETT_FOR_BEREGNING", "Vurder kompletthet for beregning", UTREDES),
    ...
    VURDER_PLEIES_I_HJEMMET("VURDER_PLEIES_I_HJEMMET", "Vurder om pleietrengende pleies i hjemmet", UTREDES),
