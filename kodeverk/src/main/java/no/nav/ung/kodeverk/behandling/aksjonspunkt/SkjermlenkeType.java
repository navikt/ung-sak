...
public enum SkjermlenkeType implements Kodeverdi {
    ...
    BOSTEDSVILKÅR("BOSTEDSVILKÅR", "Bostedsvilkår"),
    BISTANDSVILKÅR("BISTANDSVILKÅR", "Bistandsvilkår"),
    AKTIVITETSVILKÅR("AKTIVITETSVILKÅR", "Aktivitet"),
    ...
    LOKALKONTOR_FORESLÅR_VILKÅR("LOKALKONTOR_FORESLÅR_VILKÅR", "Lokalkontor foreslår vilkår"),
