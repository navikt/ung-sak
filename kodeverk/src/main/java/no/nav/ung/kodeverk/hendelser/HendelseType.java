...
public enum HendelseType implements Kodeverdi {
    ...
    UNGDOMSPROGRAM_FJERN_PERIODE("UNGDOMSPROGRAM_FJERN_PERIODE"),
    UNGDOMSPROGRAM_FORLENGET_PERIODE("UNGDOMSPROGRAM_FORLENGET_PERIODE"),
    /** @deprecated Bruk {@link #UNGDOMSPROGRAM_FORLENGET_PERIODE}. Beholdes for bakoverkompatibilitet. */
    @Deprecated UNGDOMSPROGRAM_UTVIDET_KVOTE("UNGDOMSPROGRAM_UTVIDET_KVOTE"),
