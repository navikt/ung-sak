...
public class Brevkode implements Kodeverdi {
    ...
    public static final String UNGDOMSYTELSE_ETTERLYSNING_UTTALELSE_KODE = "UNGDOMSYTELSE_BEKREFTELSE_PERIODEENDRING";
    public static final Brevkode UNGDOMSYTELSE_ETTERLYSNING_UTTALELSE = new Brevkode(UNGDOMSYTELSE_ETTERLYSNING_UTTALELSE_KODE, "NAV 76-13.94", VEDLEGG_RANGERING);
