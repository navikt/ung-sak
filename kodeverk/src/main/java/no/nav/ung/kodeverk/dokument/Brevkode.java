...
public class Brevkode implements Kodeverdi {
    ...
    public static final String UNGDOMSYTELSE_BEKREFTELSE_PERIODEENDRING_KODE = "UNGDOMSYTELSE_BEKREFTELSE_PERIODEENDRING";
    public static final Brevkode UNGDOMSYTELSE_BEKREFTELSE_PERIODEENDRING = new Brevkode(UNGDOMSYTELSE_BEKREFTELSE_PERIODEENDRING_KODE, "UNG Bekreftelse av periodeendring", VEDLEGG_RANGERING);
