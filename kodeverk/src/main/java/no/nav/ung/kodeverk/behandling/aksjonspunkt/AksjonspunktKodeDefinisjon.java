...
public class AksjonspunktKodeDefinisjon {
    ...
    public static final String MANUELL_VURDERING_AV_KLAGE_KODE = "5035";
    public static final String VURDERING_AV_FORMKRAV_KLAGE_KODE = "5082";
    ...
    public static final String FASTSETT_BOSTEDVILKÅR_KODE = "5143";
    public static final String MANUELL_VURDERING_BOSTEDSVILKÅR_KODE = "5144";
