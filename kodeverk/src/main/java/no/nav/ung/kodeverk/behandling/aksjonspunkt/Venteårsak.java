...
public enum Venteårsak implements Kodeverdi {
    ...
    VENTER_PÅ_ETTERLYST_BOSTEDUTTALELSE("VENTER_ETTERLYS_BOSTEDUTTALELSE", "Venter på svar fra bruker om bostedavklaring", false, AVVENTER_SØKER),
    VENTER_PÅ_ETTERLYST_BISTANDUTTALELSE("VENTER_ETTERLYS_BISTANDUTTALELSE", "Venter på svar fra bruker om bistandsavklaring", false, AVVENTER_SØKER),
    VENTER_PÅ_ETTERLYST_LIVSOPPHOLDSYTELSEUTTALELSE("VENTER_ETTERLYS_LIVSOPPHOLDUTTALELSE", "Venter på svar fra bruker om avklaring av andre livsoppholdsytelser", false, AVVENTER_SØKER),
