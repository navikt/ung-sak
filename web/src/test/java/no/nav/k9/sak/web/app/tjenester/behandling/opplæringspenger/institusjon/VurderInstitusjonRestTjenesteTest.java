...
@CdiDbAwareTest
class VurderInstitusjonRestTjenesteTest {

    private VurderInstitusjonRestTjeneste restTjeneste;
    @Inject
    ...
    @BeforeEach
    void setup() {
        restTjeneste = new VurderInstitusjonRestTjeneste(behandlingRepository, vurdertOpplæringRepository, godkjentOpplæringsinstitusjonTjeneste, uttakPerioderGrunnlagRepository);
