...
class MånedsvisningDtoMapperTest {
    ...
    void skal_mappe_delvis_måned_uten_kontroll_i_førstegangsbehandling() {
        ...
        final var månedstidslinje = new LocalDateTimeline<YearMonth>(fom, tom, YearMonth.of(2025, 1));
        final var tilkjentYtelseTidslinje = new LocalDateTimeline<TilkjentYtelseVerdi>(fom, tom, new TilkjentYtelseVerdi(uredusert, reduksjon, redusert, dagsats, 100));
        ...
        final var originalTilkjentYtelse = new LocalDateTimeline<TilkjentYtelseVerdi>(List.of());
        ...
        assertThat(månedDto.status()).isEqualTo(UtbetalingStatus.TIL_UTBETALING);
    ...
    void skal_mappe_to_måneder_med_kontroll_uten_inntekt_i_revurdering() {
        ...
        final var månedstidslinje = new LocalDateTimeline<YearMonth>(List.of(new LocalDateSegment<>(fomMåned1, tomMåned1, YearMonth.of(2025, 1)), new LocalDateSegment<>(fomMåned2, tomMåned2, YearMonth.of(2025, 2))));
        ...
        assertThat(månedDto2.status()).isEqualTo(UtbetalingStatus.TIL_UTBETALING);
    ...
    void skal_mappe_to_måneder_med_kontroll_uten_inntekt_i_revurdering_endring_av_sats_midt_i_andre_måned() {
        ...
        final var antallBarn = 1;
        final var satser = new UngdomsytelseSatser(dagsats, BigDecimal.valueOf(100_000), BigDecimal.valueOf(2), UngdomsytelseSatsType.HØY, antallBarn, dagsatsBarnetillegg);
        final var dagsatsBarnetillegg2 = 74;
        final var antallBarn2 = 2;
        final var satser2 = new UngdomsytelseSatser(dagsats, BigDecimal.valueOf(100_000), BigDecimal.valueOf(2), UngdomsytelseSatsType.HØY, antallBarn2, dagsatsBarnetillegg2);
