...
public class IkkeAksepterTokenX implements ContainerRequestFilter {

    @Context
    private ResourceInfo resourceinfo;

    public IkkeAksepterTokenX() {
        // Ingenting
    }
    ...
    public void filter(ContainerRequestContext req) {
        ...
        if (erTokenX) {
            throw new WebApplicationException("Kan ikke kalle med TokenX", Response.Status.FORBIDDEN);
        }
    }
