...
interface SelftestFeil extends DeklarerteFeil {
    ...
    @TekniskFeil(feilkode = "FP-287026", feilmelding = "Dupliserte healthchecks navn %s", logLevel = WARN)
    ...
    @TekniskFeil(feilkode = "FP-984256", feilmelding = "Selftest ERROR: %s. Endpoint: %s. Responstid: %s. Feilmelding: %s.", logLevel = WARN)
