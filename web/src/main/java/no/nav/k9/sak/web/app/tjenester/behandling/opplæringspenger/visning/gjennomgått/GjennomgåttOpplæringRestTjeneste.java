...
@Path("")
@Transactional
public class GjennomgåttOpplæringRestTjeneste {
    ...
    GjennomgåttOpplæringRestTjeneste() {
    }

    @Inject
    public GjennomgåttOpplæringRestTjeneste(BehandlingRepository behandlingRepository,
