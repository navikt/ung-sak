...
import no.nav.k9.sak.kontrakt.beregningsgrunnlag.aksjonspunkt.VurderVarigEndretArbeidssituasjonDtoer;
...
@ApplicationScoped
@DtoTilServiceAdapter(dto = VurderVarigEndretArbeidssituasjonDtoer.class, adapter = AksjonspunktOppdaterer.class)
public class VurderVarigEndretArbeidssituasjonOppdaterer implements AksjonspunktOppdaterer<VurderVarigEndretArbeidssituasjonDtoer> {
    ...
    VurderVarigEndretArbeidssituasjonOppdaterer() {
        // CDI
    }

    @Inject
    public VurderVarigEndretArbeidssituasjonOppdaterer(BeregningsgrunnlagOppdateringTjeneste oppdateringTjeneste,
    ...
    @Override
    public OppdateringResultat oppdater(VurderVarigEndretArbeidssituasjonDtoer dtoer, AksjonspunktOppdaterParameter param) {
        OppdateringResultat.Builder resultatBuilder = OppdateringResultat.builder();
        ...
        historikkTjeneste.lagHistorikkInnslag(param, utførteOppdateringer, dtoer.getBegrunnelse());
