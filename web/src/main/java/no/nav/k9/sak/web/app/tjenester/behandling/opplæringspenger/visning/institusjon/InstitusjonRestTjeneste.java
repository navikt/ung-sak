...
@Path("")
@Transactional
public class InstitusjonRestTjeneste {

    public static final String BASEPATH = "/behandling/institusjon";

    private BehandlingRepository behandlingRepository;
    private VurdertOpplæringRepository vurdertOpplæringRepository;
    private InstitusjonMapper mapper;
    private UttakPerioderGrunnlagRepository uttakPerioderGrunnlagRepository;

    InstitusjonRestTjeneste() {
    }

    @Inject
    public InstitusjonRestTjeneste(BehandlingRepository behandlingRepository,
        ...
        this.mapper = new InstitusjonMapper(godkjentOpplæringsinstitusjonTjeneste);
