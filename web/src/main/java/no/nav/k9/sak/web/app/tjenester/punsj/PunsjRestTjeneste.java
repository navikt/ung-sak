...
public class PunsjRestTjeneste {
    ...
    public Response getUferdigJournalpostIderPrAktoer(@NotNull @QueryParam("behandlingId") @Valid @TilpassetAbacAttributt(supplierClass = AbacAttributtSupplier.class) BehandlingIdDto behandlingIdDto) {
