...
@Path("")
@Transactional
public class NødvendigOpplæringRestTjeneste {
    ...
    NødvendigOpplæringRestTjeneste() {
    }

    @Inject
    public NødvendigOpplæringRestTjeneste(BehandlingRepository behandlingRepository,
