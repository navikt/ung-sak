...
@JsonSubTypes(value = {
    ...
    @JsonSubTypes.Type(name = Hendelse.UNGDOMSPROGRAM_FJERN_DELTAKELSE, value = UngdomsprogramFjernDeltakelseHendelse.class),
})
...
public interface Hendelse {
    ...
    String UNGDOMSPROGRAM_FJERN_DELTAKELSE = "UNGDOMSPROGRAM_FJERN_DELTAKELSE";
