...
@JsonTypeName(AksjonspunktKodeDefinisjon.ÅRSKVANTUM_FOSTERBARN)
public class ÅrskvantumFosterbarnDto extends BekreftetAksjonspunktDto {
    ...
    @JsonCreator
    public ÅrskvantumFosterbarnDto(@JsonProperty(value = "begrunnelse", required = true) String begrunnelse,
    ...
    protected ÅrskvantumFosterbarnDto() {
        //
    }
