...
public enum SykdomDokumentType {
    ...
    DOKUMENTASJON_AV_OPPLÆRING("DOKUMENTASJON_AV_OPPLÆRING", "DO", false),
    LEGEERKLÆRING_MED_DOKUMENTASJON_AV_OPPLÆRING("LEGEERKLÆRING_MED_DOKUMENTASJON_AV_OPPLÆRING", "LDO", true);
