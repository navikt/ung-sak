...
public class AvklarKompletthetForBeregningDto extends BekreftetAksjonspunktDto {
    ...
    @JsonCreator
    public AvklarKompletthetForBeregningDto(@JsonProperty("begrunnelse") @Size(max = 4000) @Pattern(regexp = Patterns.FRITEKST, message = "[${validatedValue}] matcher ikke tillatt pattern [{regexp}]") String begrunnelse,
