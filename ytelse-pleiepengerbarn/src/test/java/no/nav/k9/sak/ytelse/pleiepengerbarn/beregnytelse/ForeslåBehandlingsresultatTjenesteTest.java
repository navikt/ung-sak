...
public class ForeslåBehandlingsresultatTjenesteTest {
    ...
    private void lagreUttak(Behandling behandling) {
        ...
        UttaksperiodeInfo uttaksperiodeInfo = new UttaksperiodeInfo(no.nav.pleiepengerbarn.uttak.kontrakter.Utfall.OPPFYLT, BigDecimal.valueOf(100), null, null, BigDecimal.ZERO, List.of(), BigDecimal.valueOf(100), null, Set.of(), Map.of(), BigDecimal.valueOf(100), null, Set.of(), behandling.getUuid().toString(), AnnenPart.ALENE, null, null, null, false, new Utenlandsopphold(null, UtenlandsoppholdÅrsak.INGEN), false);
