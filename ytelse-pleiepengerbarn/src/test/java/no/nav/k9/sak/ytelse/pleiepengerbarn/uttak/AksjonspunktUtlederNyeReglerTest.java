...
public class AksjonspunktUtlederNyeReglerTest {
    ...
    void skal_få_aksjonspunkt_for_førstegangsbehandling_uten_dato_satt() {
        ...
        when(tilkommetAktivitetTjeneste.finnTilkommedeAktiviteter(anyLong(), any(LocalDate.class))).thenReturn(Map.of(new AktivitetstatusOgArbeidsgiver(UttakArbeidType.FRILANSER, null), LocalDateTimeline.empty()));
