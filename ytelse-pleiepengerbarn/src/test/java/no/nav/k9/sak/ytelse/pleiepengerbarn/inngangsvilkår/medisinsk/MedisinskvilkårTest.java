...
public class MedisinskvilkårTest {
    ...
    public void skal_avslå_hvis_det_ikke_er_diagnose() {
        final var grunnlag = new MedisinskvilkårGrunnlag(LocalDate.now().minusWeeks(8), LocalDate.now(), grunnlag);
    ...
    public void skal_avslå_hvis_det_ikke_er_dokumentert_av_rett_organ() {
        ...
        final var grunnlag1 = new MedisinskvilkårGrunnlag(LocalDate.now().minusWeeks(8), LocalDate.now(), grunnlag)
            .medDiagnoseKode("SYK")
    ...
    public void skal_godkjenne_perioden_med_innleggelse() {
        ...
        final var grunnlag = new MedisinskvilkårGrunnlag(fom, tom, grunnlag)
            .medDiagnoseKode("SYK")
            .medDiagnoseKilde(DiagnoseKilde.SYKHUSLEGE)
