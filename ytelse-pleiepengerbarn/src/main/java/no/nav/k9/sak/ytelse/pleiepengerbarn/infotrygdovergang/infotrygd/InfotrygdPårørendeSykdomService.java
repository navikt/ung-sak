...
@Dependent
public class InfotrygdPårørendeSykdomService {

    private static final Logger log = LoggerFactory.getLogger(InfotrygdPårørendeSykdomService.class);

    private final InfotrygdPårørendeSykdomClient client;

    @Inject
    public InfotrygdPårørendeSykdomService(InfotrygdPårørendeSykdomClient client) {
        this.client = client;
    }
