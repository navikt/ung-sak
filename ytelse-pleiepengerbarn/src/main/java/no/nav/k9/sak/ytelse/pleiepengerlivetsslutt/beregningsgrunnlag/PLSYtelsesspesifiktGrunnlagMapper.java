...
@ApplicationScoped
public class PLSYtelsesspesifiktGrunnlagMapper implements BeregningsgrunnlagYtelsespesifiktGrunnlagMapper<PleiepengerNærståendeGrunnlag> {

    private UttakTjeneste uttakRestKlient;

    public PLSYtelsesspesifiktGrunnlagMapper() {
        // for proxy
    }

    @Inject
    public PLSYtelsesspesifiktGrunnlagMapper(UttakTjeneste uttakRestKlient) {
