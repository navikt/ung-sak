...
public class PSBVurderSøknadsfristTjeneste implements SøknadsfristTjeneste {
    ...
    VilkårResultatBuilder mapVurderingerTilVilkårsresultat(VilkårResultatBuilder vilkårResultatBuilder,
                                                           Map<KravDokument, List<SøktPeriode<Søknadsperiode>>> søktePerioder,
                                                           Map<KravDokument, List<VurdertSøktPeriode<Søknadsperiode>>> vurdertePerioder,
    ...
    private LocalDateTimeline<Utfall> slåSammenTidslinjer(Map<KravDokument, List<VurdertSøktPeriode<Søknadsperiode>>> vurdertePerioder) {
    ...
    private LocalDateTimeline<Utfall> mapTilTimeline(List<VurdertSøktPeriode<Søknadsperiode>> perioder) {
