...
public class ProsessModell {
    ...
    public BehandlingModell førstegangsbehandling() {
        ...
        modellBuilder
            ...
            .medSteg(BehandlingStegType.KONTROLLER_FAKTA_UTTAK, StartpunktType.UTTAKSVILKÅR)
            .medSteg(BehandlingStegType.VURDER_UTTAK)
            .medSteg(BehandlingStegType.PRECONDITION_BEREGNING)
            .medSteg(BehandlingStegType.VURDER_KOMPLETTHET_BEREGNING, StartpunktType.BEREGNING)
