...
public class MedisinskVilkårTjeneste {
    ...
    public VilkårData vurderPerioder(VilkårType vilkåret, DatoIntervallEntitet periodeTilVurdering, MedisinskGrunnlag medisinskGrunnlag) {
        MedisinskVilkårGrunnlag grunnlag = inngangsvilkårOversetter.oversettTilRegelModellMedisinsk(periodeTilVurdering, medisinskGrunnlag);
