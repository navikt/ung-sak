...
abstract class AbstractUngdomsytelseVedtaksbrevInnholdByggerTest {
    ...
    AbstractUngdomsytelseVedtaksbrevInnholdByggerTest(int forventetAntallPdfSider, String forventetPdfHovedoverskrift) {
