...
public class UngdomsytelseInnhentDokumentTjeneste implements InnhentDokumentTjeneste {

    private static final Logger log = LoggerFactory.getLogger(UngdomsytelseInnhentDokumentTjeneste.class);
    ...
    @Inject
    public UngdomsytelseInnhentDokumentTjeneste(@Any Instance<Dokumentmottaker> mottakere,
