...
import no.nav.ung.kodeverk.behandling.FagsakYtelseType;import no.nav.ung.sak.behandling.revurdering.ÅrsakOgPerioder;
...
public class PdlDødsfallFagsakTilVurderingUtleder implements FagsakerTilVurderingUtleder {
    ...
    private HashMap<Fagsak, List<ÅrsakOgPerioder>> finnPåvirketFagsak(AktørId aktør, LocalDate aktuellDato, String hendelseId) {
        ...
        var fagsakForAktør = finnFagsakerForAktørTjeneste.hentRelevantFagsakForAktørSomSøker(FagsakYtelseType.UNGDOMSYTELSE, aktør, aktuellDato);
        ...
        finnFagsakerForAktørTjeneste.hentRelevantFagsakForAktørSomBarnAvSøker(FagsakYtelseType.UNGDOMSYTELSE, aktør, aktuellDato)
            .stream()
