...
public class UngDetaljertResultatTidslinjeUtleder implements DetaljertResultatTidslinjeUtleder {
    ...
    public LocalDateTimeline<DetaljertResultat> utledDetaljertResultat(Behandling behandling) {
        ...
        // vurdering blir med. Da ser strategiene hele vilkårsbildet (bl.a. AvslagStrategy som skiller fullt avslag fra
        // opphør/kombinasjoner). Behandlingsårsaker er kun satt på perioder til vurdering.
        var vilkårOgBehandlingsårsakerTidslinje = perioderTilVurdering
            .combine(samletVilkårTidslinje,
                (p, behandlingÅrsaker, vilkårResultater) -> {
                    ...
                    return new LocalDateSegment<>(p, new UngDetaljertResultatPeriodeGrunnlag(vilkår, årsaker, tilVurdering));
    ...
    private LocalDateSegmentCombinator<UngDetaljertResultatPeriodeGrunnlag, TilkjentYtelseVerdi, DetaljertResultat> byggDetaljertResultatCombinator() {
        return (p, lhs, rhs) -> {
