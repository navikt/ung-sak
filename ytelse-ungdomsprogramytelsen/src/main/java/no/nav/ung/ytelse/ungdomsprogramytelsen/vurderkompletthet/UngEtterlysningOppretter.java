...
public class UngEtterlysningOppretter implements EtterlysningOppretter {
    ...
    public void opprettEtterlysninger(BehandlingReferanse behandlingReferanse) {
        ...
        if (årsaker.contains(BehandlingÅrsakType.RE_HENDELSE_OPPHØR_OPPHEVET_UNGDOMSPROGRAM)) {
            ...
            // (pga. en race — opphevOpphør-hendelsen kan bli slått sammen med en fortsatt åpen behandling som
            // venter på bekreftelse av det nå opphevede opphøret) fortsatt har den utdaterte årsaken
            // RE_HENDELSE_OPPHØR_UNGDOMSPROGRAM liggende igjen. Vi avbryter derfor alltid slike sluttdato-
            // etterlysninger her, uavhengig av hvilke andre årsaker som finnes. Etterlysninger om endret
            // startdato/periode berøres ikke, da opphevelse av opphør ikke sier noe om disse.
     ...
     * samme behandling. Andre årsaker (f.eks. inntektskontroll) regnes derimot fortsatt som reelle tilleggsårsaker.
     */
