...
public class UngdomsytelseProsessTriggerPeriodeUtleder implements ProsessTriggerPeriodeUtleder {
    ...
    @Inject
    public UngdomsytelseProsessTriggerPeriodeUtleder(ProsessTriggereRepository prosessTriggereRepository, UngdomsytelseSøknadsperiodeTjeneste ungdomsytelseSøknadsperiodeTjeneste) {
