...
public final class BrevkodeInformasjonUtleder {
    ...
    private static Map<String, BrevkodeInformasjon> createTitler() {
        ...
        brevkodeliste.add(new BrevkodeInformasjon(Brevkode.AKTIVITETSPENGER_INNTEKTRAPPORTERING.getOffisiellKode(), null, null, FagsakYtelseType.AKTIVITETSPENGER, FordelBehandlingType.DIGITAL_SØKNAD));
