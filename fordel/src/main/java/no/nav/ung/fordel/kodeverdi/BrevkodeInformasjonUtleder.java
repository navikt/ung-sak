...
public final class BrevkodeInformasjonUtleder {
    ...
    private static Map<String, BrevkodeInformasjon> createTitler() {
        ...
        brevkodeliste.add(new BrevkodeInformasjon(Brevkode.UNGDOMSYTELSE_OPPGAVE_BEKREFTELSE.getOffisiellKode(), null, "Bekreftelse av periodeendring for ungdomsprogrammet", FagsakYtelseType.UNGDOMSYTELSE, null, FordelBehandlingType.DIGITAL_SØKNAD, false));
