...
@Dependent
public class OpprettRevurderingHøySatsTaskTjeneste {

    private static final Logger log = LoggerFactory.getLogger(OpprettRevurderingHøySatsTaskTjeneste.class);

    private final ProsessTaskTjeneste prosessTaskTjeneste;
    private final FagsakProsessTaskRepository fagsakProsessTaskRepository;

    OpprettRevurderingHøySatsTaskTjeneste() {
        this(null, null);
    }

    @Inject
    public OpprettRevurderingHøySatsTaskTjeneste(ProsessTaskTjeneste prosessTaskTjeneste, FagsakProsessTaskRepository fagsakProsessTaskRepository) {
        this.prosessTaskTjeneste = prosessTaskTjeneste;
        this.fagsakProsessTaskRepository = fagsakProsessTaskRepository;
    }

    public void opprettRevurderingTasks(ProsessTaskData prosessTaskData, Map<Fagsak, LocalDate> fagsakerMedEndringsdato) {
