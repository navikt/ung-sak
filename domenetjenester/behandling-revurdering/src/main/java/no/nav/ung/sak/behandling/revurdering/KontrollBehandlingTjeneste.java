...
@BehandlingTypeRef
@ApplicationScoped
public class KontrollBehandlingTjeneste {
    ...
    public KontrollBehandlingTjeneste() {
        // for CDI proxy
    }

    @Inject
    public KontrollBehandlingTjeneste(BehandlingskontrollTjeneste behandlingskontrollTjeneste,
    ...
    public Behandling opprettKontrollbehandling(Behandling origBehandling, BehandlingÅrsakType revurderingsÅrsak, OrganisasjonsEnhet enhet) {
        validerTilstand(origBehandling);
        var revurdering = opprettKontrollbehandling(origBehandling, revurderingsÅrsak, false, enhet);
    ...
    private Behandling opprettKontrollbehandling(Behandling origBehandling, BehandlingÅrsakType revurderingsÅrsak, boolean manueltOpprettet, OrganisasjonsEnhet enhet) {
        behandlingskontrollTjeneste.initBehandlingskontroll(origBehandling);

        // Opprett revurderingsbehandling
        Behandling revurdering = revurderingTjenesteFelles.opprettNyBehandling(BehandlingType.KONTROLLBEHANDLING, revurderingsÅrsak, origBehandling, manueltOpprettet, enhet);
