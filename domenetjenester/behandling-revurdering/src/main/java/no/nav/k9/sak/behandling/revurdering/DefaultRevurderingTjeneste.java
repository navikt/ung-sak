...
@BehandlingTypeRef
@ApplicationScoped
public class DefaultRevurderingTjeneste implements RevurderingTjeneste {
    ...
    public DefaultRevurderingTjeneste() {
        // for CDI proxy
    }

    @Inject
    public DefaultRevurderingTjeneste(BehandlingskontrollTjeneste behandlingskontrollTjeneste,
