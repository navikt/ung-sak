...
class SatsEndringRepositoryTest {
    ...
    private void opprettSatsPeriode(Behandling behandling, UngdomsytelseSatsType satstype) {
        ...
        entityManager.createNativeQuery("INSERT INTO UNG_SATS_PERIODE (id, ung_sats_perioder_id, periode, dagsats, grunnbeløp, grunnbeløp_faktor, sats_type, antall_barn, dagsats_barnetillegg, hjemmel) VALUES (1, :satsPerioderId, '[2021-01-01,2021-12-31]', 1000, 1000, 1, '"+ satstype.getKode() +"', 0, 0, '" + Hjemmel.UNG_FORSKRIFT_PARAGRAF_9.getKode() + "')")
