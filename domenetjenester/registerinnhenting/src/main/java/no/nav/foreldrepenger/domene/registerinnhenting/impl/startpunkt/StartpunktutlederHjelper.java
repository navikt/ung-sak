...
class StartpunktutlederHjelper {
    ...
    private StartpunktutlederHjelper() {
        // Skal ikke konstrueres
    }

    static boolean finnesAktivitetHvorAlleHarDagsatsNull(BeregningsresultatEntitet beregningsresultat) {
    ...
    private static Map<Aktivitetsnøkkel, List<BeregningsresultatAndel>> indekserAndelerMotArbeidsforhold(List<BeregningsresultatAndel> andeler) {
