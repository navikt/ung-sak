package no.nav.k9.sak.inngangsvilkår.opptjeningsperiode.regelmodell;
...
public class FastsettOpptjeningsperiode extends LeafSpecification<OpptjeningsperiodeGrunnlag> {
    ...
    static final String BESKRIVELSE = "Regnes relativt til Skjæringstidspunkt fra konfig('fp.opptjeningsperiode.lengde') til dagen før (siste dag i opptjeningsperioden)";
