...
public class MapArbeidsforholdFraVLTilRegel {
    ...
    private static boolean erFrilanser(no.nav.foreldrepenger.behandlingslager.behandling.aktivitet.AktivitetStatus aktivitetStatus) {
        return no.nav.foreldrepenger.behandlingslager.behandling.aktivitet.AktivitetStatus.FRILANSER.equals(aktivitetStatus);
    }
