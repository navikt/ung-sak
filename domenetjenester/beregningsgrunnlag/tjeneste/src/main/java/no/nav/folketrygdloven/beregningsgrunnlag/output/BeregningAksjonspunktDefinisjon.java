...
public
enum BeregningAksjonspunktDefinisjon implements Kodeverdi {
    ...
    @JsonCreator
    public static BeregningAksjonspunktDefinisjon fraKode(@JsonProperty("kode") String kode) {
        if (kode == null) {
            return null;
        }
    ...
    public static class KodeverdiConverter implements AttributeConverter<BeregningAksjonspunktDefinisjon, String> {
        @Override
        public String convertToDatabaseColumn(BeregningAksjonspunktDefinisjon attribute) {
            return attribute == null ? null : attribute.getKode();
        }

        @Override
        public BeregningAksjonspunktDefinisjon convertToEntityAttribute(String dbData) {
            return dbData == null ? null : BeregningAksjonspunktDefinisjon.fraKode(dbData);
        }
    }
}
