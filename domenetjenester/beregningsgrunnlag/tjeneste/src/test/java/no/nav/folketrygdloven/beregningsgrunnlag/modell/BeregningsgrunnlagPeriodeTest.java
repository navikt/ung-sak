...
public class BeregningsgrunnlagPeriodeTest {
    ...
    public void skal_ikke_bygge_instans_hvis_mangler_påkrevde_felter() {
        var beregningsgrunnlagPeriodeBuilder = BeregningsgrunnlagPeriode.builder();
        try {
    ...
    private BeregningsgrunnlagPeriode lagMedPaakrevdeFelter(BeregningsgrunnlagEntitet beregningsgrunnlag) {
