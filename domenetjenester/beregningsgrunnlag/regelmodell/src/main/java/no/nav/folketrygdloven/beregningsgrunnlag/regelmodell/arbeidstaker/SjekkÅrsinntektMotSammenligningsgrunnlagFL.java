...
@RuleDocumentation(SjekkÅrsinntektMotSammenligningsgrunnlagFL.ID)
class SjekkÅrsinntektMotSammenligningsgrunnlagFL extends LeafSpecification<BeregningsgrunnlagPeriode> {

    static final String ID = "FP_BR 28.3";
    ...
    SjekkÅrsinntektMotSammenligningsgrunnlagFL() {
    ...
    public Evaluation evaluate(BeregningsgrunnlagPeriode grunnlag) {
        ...
        BigDecimal rapporertInntekt = bgps.getBeregnetPrÅrForFL();
