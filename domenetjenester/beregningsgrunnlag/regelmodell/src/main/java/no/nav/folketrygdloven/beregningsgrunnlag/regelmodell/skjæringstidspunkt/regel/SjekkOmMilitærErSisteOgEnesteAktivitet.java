package no.nav.folketrygdloven.beregningsgrunnlag.regelmodell.skjæringstidspunkt.regel;

import static no.nav.folketrygdloven.beregningsgrunnlag.regelmodell.regelmodell.Aktivitet.MILITÆR_ELLER_SIVILTJENESTE;
