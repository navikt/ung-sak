...
import no.nav.folketrygdloven.beregningsgrunnlag.regelmodell.perioder.IdentifiserPerioderForRefusjon;
...
public class IdentifiserPerioderForRefusjonTest {
    ...
    public void refusjonFraSkjæringstidspunkt() {
        ...
        var im = ArbeidsforholdOgInntektsmelding.builder()
            ...
            .medRefusjonskrav(List.of(new Refusjonskrav(BigDecimal.TEN, SKJÆRINGSTIDSPUNKT, Tid.TIDENES_ENDE)))
            .build();
    ...
    public void refusjonFraSenereDato() {
        ...
        ArbeidsforholdOgInntektsmelding im = ArbeidsforholdOgInntektsmelding.builder()
            ...
            .medRefusjonskrav(List.of(
                ...
                new Refusjonskrav(BigDecimal.TEN, endringFom, Tid.TIDENES_ENDE)
            ))
            .build();
    ...
    public void refusjonFraStartOgOpphør() {
        ...
        ArbeidsforholdOgInntektsmelding im = ArbeidsforholdOgInntektsmelding.builder()
            ...
            .medRefusjonskrav(List.of(
                ...
                new Refusjonskrav(BigDecimal.ZERO, opphørFom, Tid.TIDENES_ENDE)
            ))
            .build();
    ...
    public void refusjonFraStartOgEndring() {
        ...
        ArbeidsforholdOgInntektsmelding im = ArbeidsforholdOgInntektsmelding.builder()
            ...
            .medRefusjonskrav(List.of(
                ...
                new Refusjonskrav(BigDecimal.valueOf(10000), endringFom, Tid.TIDENES_ENDE)
            ))
            .build();
