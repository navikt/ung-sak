...
public class HentAktiviteterForBeregningTjenesteImplTest {
    ...
    public void setUp() {
        ...
        beregningIAYTestUtil = new BeregningIAYTestUtil(iayTjeneste);
    }
    ...
    public void skal_ikkje_filtrere_ut_frilanser_om_oppgitt_i_søknaden() {
        // Arrange
        beregningIAYTestUtil.lagAnnenAktivitetOppgittOpptjening(behandlingReferanse, ArbeidType.FRILANSER, SKJÆRINGSTIDSPUNKT_OPPTJENING.minusMonths(10), SKJÆRINGSTIDSPUNKT_OPPTJENING.minusDays(1));
