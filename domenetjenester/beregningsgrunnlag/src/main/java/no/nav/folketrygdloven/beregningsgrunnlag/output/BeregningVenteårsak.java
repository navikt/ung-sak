...
public enum BeregningVenteårsak implements Kodeverdi {
    ...
    @JsonCreator
    public static BeregningVenteårsak fraKode(@JsonProperty("kode") String kode) {
        if (kode == null) {
            return null;
        }
    ...
    public static class KodeverdiConverter implements AttributeConverter<BeregningVenteårsak, String> {
        @Override
