...
public class MapInntektskategoriRegelTilVL {
    ...
    static {
        Map<no.nav.folketrygdloven.beregningsgrunnlag.regelmodell.grunnlag.inntekt.Inntektskategori, no.nav.foreldrepenger.behandlingslager.behandling.aktivitet.Inntektskategori> map = new EnumMap<>(no.nav.folketrygdloven.beregningsgrunnlag.regelmodell.grunnlag.inntekt.Inntektskategori.class);
