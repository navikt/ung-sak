...
import static no.nav.ung.sak.innsyn.hendelse.republisering.RepubliserInnsynEventTask.ANTALL_PER_KJØRING_PROP;
import static no.nav.ung.sak.innsyn.hendelse.republisering.RepubliserInnsynEventTask.KJØRING_ID_PROP;
