...
@ApplicationScoped
public class FormidlingRestKlientImpl implements FormidlingRestKlient {
    ...
    public FormidlingRestKlientImpl() {
        //CDI
    }

    @Inject
    public FormidlingRestKlientImpl(OidcRestClient oidcRestClient,
