...
public class InnhentDokumentTjenesteTest {
    ...
    public void oppsett() {
        ...
        when(dokumentmottaker.getBehandlingÅrsakType(Brevkode.UNGDOMSYTELSE_SOKNAD)).thenReturn(BehandlingÅrsakType.BERØRT_BEHANDLING);
    }
    ...
    public void skal_oppdatere_behandling_vurdere_kompletthet_og_spole_til_nytt_startpunkt_dersom_fagsak_har_avsluttet_behandling_har_åpen_behandling_og_kompletthet_passert() {
        ...
        // Arrange - bygg dok
        MottattDokument mottattDokument = DokumentmottakTestUtil.byggMottattDokument(revurderingBehandling.getFagsakId(), "", now(), "123", Brevkode.UNGDOMSYTELSE_SOKNAD);
