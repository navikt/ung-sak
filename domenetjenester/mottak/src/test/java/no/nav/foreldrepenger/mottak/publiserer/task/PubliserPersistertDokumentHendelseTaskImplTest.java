...
public class PubliserPersistertDokumentHendelseTaskImplTest {

    private static final JournalpostId JOURNALPOST_ID = new JournalpostId("2");
    private static final AktørId AKTØR_ID = new AktørId("1111111111111");
    ...
    public void before() {
        ...
        final Personinfo personinfo = new Personinfo.Builder()
            ...
            .build();
        FAGSAK_ID = repositoryProvider.getFagsakRepository().opprettNy(Fagsak.opprettNy(FagsakYtelseType.FORELDREPENGER, NavBruker.opprettNy(personinfo), SAKSNUMMER));
        ...
        publiserPersistertDokumentHendelseTask = new PubliserPersistertDokumentHendelseTaskImpl(fagsakRepository, mottatteDokumentTjeneste, inntektsmeldingTjeneste, dialogHendelseProducer);
    }
