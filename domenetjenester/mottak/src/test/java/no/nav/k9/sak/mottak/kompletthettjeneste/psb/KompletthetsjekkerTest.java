...
import no.nav.k9.sak.mottak.kompletthettjeneste.psb.KompletthetsjekkerFelles;
import no.nav.k9.sak.mottak.kompletthettjeneste.psb.KompletthetsjekkerImpl;
import no.nav.k9.sak.mottak.kompletthettjeneste.psb.KompletthetssjekkerInntektsmeldingImpl;
import no.nav.k9.sak.mottak.kompletthettjeneste.psb.KompletthetssjekkerSøknadFørstegangsbehandlingImpl;
import no.nav.k9.sak.mottak.kompletthettjeneste.psb.KompletthetssjekkerSøknadImpl;
