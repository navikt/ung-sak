...
@ApplicationScoped
public class NyBehandlingOppretterKontrollbehandling implements NyBehandlingOppretter {

    private BehandlendeEnhetTjeneste behandlendeEnhetTjeneste;

    @Inject
    public NyBehandlingOppretterKontrollbehandling(BehandlendeEnhetTjeneste behandlendeEnhetTjeneste) {
