...
public class EndretSluttdatoBekreftelseHåndterer implements BekreftelseHåndterer {
    ...
    @Inject
    public EndretSluttdatoBekreftelseHåndterer(MottatteDokumentRepository mottatteDokumentRepository, EtterlysningRepository etterlysningRepository) {
    ...
    public void håndter(OppgaveBekreftelseInnhold oppgaveBekreftelse) {
        EndretSluttdatoBekreftelse bekreftelse = oppgaveBekreftelse.oppgaveBekreftelse().getBekreftelse();
