package no.nav.ung.sak.mottak.inntektsmelding.v1;
...
import no.nav.ung.sak.mottak.inntektsmelding.InntektsmeldingFeil;
import no.nav.ung.sak.mottak.inntektsmelding.MottattInntektsmeldingOversetter;
import no.nav.ung.sak.mottak.inntektsmelding.NamespaceRef;
import no.nav.ung.sak.mottak.inntektsmelding.ValiderInntektsmelding;
