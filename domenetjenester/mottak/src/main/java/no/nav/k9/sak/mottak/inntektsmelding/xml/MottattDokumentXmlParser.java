...
public final class MottattDokumentXmlParser {
    ...
    public static MottattInntektsmeldingWrapper unmarshallXml(JournalpostId journalpostId, String xml) {
        ...
        try {
            ...
            if (dokumentParserKonfig == null) {
                throw MottattDokumentException.FACTORY.ukjentNamespace(namespace);
            }
            ...
            throw MottattDokumentException.FACTORY.uventetFeilVedParsingAvXml(namespace, e);
        }
    }
    ...
    private static String hentNamespace(String xml) {
        ...
        try {
            ...
            throw MottattDokumentException.FACTORY.uventetFeilVedParsingAvXml("ukjent", e); //$NON-NLS-1$
        }
        return namespace;
    }
