...
public interface MottattInntektsmeldingFeil extends DeklarerteFeil {
    ...
    @TekniskFeil(feilkode = "FP-187533", feilmelding = "Ugyldig inntektsmelding [journalpost=%s], bryter med forretningsregel validering: %s", logLevel = WARN, exceptionClass = MottattInntektsmeldingException.class)
