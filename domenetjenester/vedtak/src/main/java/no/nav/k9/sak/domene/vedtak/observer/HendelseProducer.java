...
public class HendelseProducer {
    ...
    public HendelseProducer(String topic,
                            String bootstrapServers,
                            String schemaRegistryUrl,
                            String username,
                            String password) {
        Properties properties = KafkaPropertiesUtil.opprettProperties(bootstrapServers, schemaRegistryUrl, getProducerClientId(topic), username, password);
