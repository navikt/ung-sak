package no.nav.ung.sak.domene.vedtak.midlertidig;

import static no.nav.ung.sak.domene.vedtak.midlertidig.PublisereHistoriskeVedtakHendelserTask.TASKTYPE;
