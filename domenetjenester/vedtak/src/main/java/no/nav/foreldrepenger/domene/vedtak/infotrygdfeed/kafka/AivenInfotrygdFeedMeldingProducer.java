...
@ApplicationScoped
public class AivenInfotrygdFeedMeldingProducer extends AivenMeldingProducer {
    public AivenInfotrygdFeedMeldingProducer() {
        // for CDI proxy
    }

    @Inject
    public AivenInfotrygdFeedMeldingProducer(@KonfigVerdi(value = "KAFKA_BROKERS") String bootstrapServers,
        ...
        super(topic, bootstrapServers, "KP-" + topic, trustStorePath, trustStorePassword, keyStorePath, keyStorePassword, aivenEnabled);
    }
}
