...
import no.nav.foreldrepenger.ytelse.beregning.tilbaketrekk.OmfordelUtbetaltYtelse;

/**
 * Dokumentasjon: https://confluence.adeo.no/display/MODNAV/5g+Fordele+beregningsgrunnlag+riktig+bakover+i+tid
 */
public class OmfordelUtbetaltYtelseTest {
    ...
    public void ingen_endring_bruker_arbeidsgiver() {
        ...
        // Act
        var resultat = OmfordelUtbetaltYtelse.omfordel(forrigeAndeler, bgAndeler);
    ...
    public void ingen_endring_bruker() {
        ...
        // Act
        List<BeregningsresultatAndel.Builder> resultat = OmfordelUtbetaltYtelse.omfordel(forrigeAndeler, bgAndeler);
