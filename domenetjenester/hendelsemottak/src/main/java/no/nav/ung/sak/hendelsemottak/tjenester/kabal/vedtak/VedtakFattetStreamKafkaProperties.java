...
@Dependent
class VedtakFattetStreamKafkaProperties {

    private static final Logger log = LoggerFactory.getLogger(VedtakFattetStreamKafkaProperties.class);
    ...
    @Inject
    VedtakFattetStreamKafkaProperties(@KonfigVerdi(value = "KAFKA_BROKERS") String bootstrapServers,
                                      @KonfigVerdi(value = "KAFKA_KABAL_TOPIC") String topicName,
