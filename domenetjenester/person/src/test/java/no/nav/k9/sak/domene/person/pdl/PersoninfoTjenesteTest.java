...
class PersoninfoTjenesteTest {
    @Test
    void midlertidig_oppholdsadresse_uten_innhold_skal_ikke_påvirke_bostedadressene() {
        ...
        AdressePeriode adresssperiode2 = AdressePeriode.builder()
            .medGyldighetsperiode(Gyldighetsperiode.innenfor(LocalDate.of(2022, 9, 25), LocalDate.of(9999, 12, 31)))
            .medAdresseType(AdresseType.BOSTEDSADRESSE)
            .medMatrikkelId("m1")
            ...
            .medLand("NOR")
            .build();
        Assertions.assertThat(periodisertAdresse2).containsOnly(adresssperiode1, adresssperiode2);
    }

    @Test
    void midlertidig_ukjent_bostedsadresse_skaL_inngå_i_bostedadressene() {
        ...
        //String angittFlyttedato, Date gyldigFraOgMed, Date gyldigTilOgMed, String coAdressenavn, Vegadresse vegadresse, Matrikkeladresse matrikkeladresse, UtenlandskAdresse utenlandskAdresse, UkjentBosted ukjentBosted, Folkeregistermetadata folkeregistermetadata, Metadata metadata
        Bostedsadresse bostedsadresse1 = new Bostedsadresse("2022-09-25", Date.from(Instant.parse("2022-10-20T22:00:00.000Z")), null, null, vegadresse1, null, null, null, null, null);
        Bostedsadresse bostedsadresse2 = new Bostedsadresse("2022-06-06", Date.from(Instant.parse("2022-07-10T23:00:00.000Z")), null, null, null, null, null, null, null, null);
        Bostedsadresse bostedsadresse3 = new Bostedsadresse(null, Date.from(Instant.parse("2021-01-28T23:00:00.000Z")), null, null, vegadresse2, null, null, null, null, null);
        List<AdressePeriode> adressene = PersoninfoTjeneste.mapAdresserHistorikk(List.of(bostedsadresse1, bostedsadresse2, bostedsadresse3), List.of(), List.of(oppholdsadresse));
        List<AdressePeriode> periodisertAdresse2 = PersoninfoTjeneste.periodiserAdresse(adressene);

        AdressePeriode adresssperiode1 = AdressePeriode.builder()
            .medGyldighetsperiode(Gyldighetsperiode.innenfor(LocalDate.of(2021, 1, 29), LocalDate.of(2022, 6, 5)))
            .medAdresseType(AdresseType.BOSTEDSADRESSE)
            .medMatrikkelId("m2")
            .medAdresselinje1("VEI 2")
            .medPostnummer("0001")
            ...
            .build();
        AdressePeriode adresssperiode2 = AdressePeriode.builder()
            .medGyldighetsperiode(Gyldighetsperiode.innenfor(LocalDate.of(2022, 6, 6), LocalDate.of(2022, 9, 24)))
        ...
        AdressePeriode adresssperiode3 = AdressePeriode.builder()
            ...
            .medLand("NOR")
            .build();
        Assertions.assertThat(periodisertAdresse2).containsOnly(adresssperiode1, adresssperiode2, adresssperiode3);
    }
}
