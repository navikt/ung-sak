...
class OpptjeningsperioderTjenesteTest {
    ...
    public void setUp() {
        ...
        opptjeningsperioderTjeneste = new OpptjeningsperioderTjeneste(repositoryProvider.getOpptjeningRepository(), oppgittOpptjeningFilterProvider, fagsakRepository);
