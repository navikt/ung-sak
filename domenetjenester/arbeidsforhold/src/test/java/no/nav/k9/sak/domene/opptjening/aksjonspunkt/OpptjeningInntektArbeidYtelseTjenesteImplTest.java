...
public class OpptjeningInntektArbeidYtelseTjenesteImplTest {
    ...
    public void setup() {
        ...
        asdf = new OpptjeningsperioderTjeneste(iayTjeneste, repositoryProvider.getOpptjeningRepository(), apoOpptjening, apbOpptjening, oppgittOpptjeningFilterProvider);
