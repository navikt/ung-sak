package no.nav.foreldrepenger.domene.arbeidsforhold.inntektsmelding;
...
import no.nav.foreldrepenger.domene.arbeidsforhold.impl.InntektsmeldingFilterYtelseImpl;
...
public class InntektsmeldingTjenesteImplTest {
    ...
    private Fagsak opprettFagsak() {
        final Personinfo personinfo = new Personinfo.Builder()
            ...
            .build();
        final Fagsak fagsak = Fagsak.opprettNy(FagsakYtelseType.FORELDREPENGER, NavBruker.opprettNy(personinfo), new Saksnummer("123"));
