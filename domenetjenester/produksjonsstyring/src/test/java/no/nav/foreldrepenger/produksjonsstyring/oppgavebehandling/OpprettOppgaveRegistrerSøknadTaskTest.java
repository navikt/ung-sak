...
public class OpprettOppgaveRegistrerSøknadTaskTest {
    ...
    public void before() {
        ...
        opprettOppgaveRegistrerSøknadTask = new OpprettOppgaveRegistrerSøknadTask(oppgaveTjeneste, TestScenarioBuilder.builderMedSøknad().mockBehandlingRepositoryProvider());
    }
