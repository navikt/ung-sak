...
//
//        List<Beregningsgrunnlag> mappetGrunnlag = MapTilBeregningsgrunnlag.mapBeregningsgrunnlag(bg);
//
...
//
//        List<Beregningsgrunnlag> mappetGrunnlag = MapTilBeregningsgrunnlag.mapBeregningsgrunnlag(bgRevurdering);
//
//        assertThat(mappetGrunnlag.size()).isEqualTo(1);
//        assertThat(mappetGrunnlag.get(0).getBeregningsgrunnlagPerioder().size()).isEqualTo(1);
...
//
//        List<Beregningsgrunnlag> mappetGrunnlag = MapTilBeregningsgrunnlag.mapBeregningsgrunnlag(bgRevurderingSøknad);
//
//        assertThat(mappetGrunnlag.size()).isEqualTo(1);
