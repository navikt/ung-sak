...
public class EndringIBeregningTjenesteFRISINN implements ErEndringIBeregningVurderer {
    ...
    @Inject
    public EndringIBeregningTjenesteFRISINN(UttakRepository uttakRepository, BeregningsresultatRepository beregningsresultatRepository) {
    ...
    public Map<LocalDate, Boolean> vurderUgunst(BehandlingReferanse original, BehandlingReferanse revurdering, NavigableSet<LocalDate> skjæringstidspunkter) {
        ...
        Optional<BeregningsresultatEntitet> orginaltResultat = beregningsresultatRepository.hentEndeligBeregningsresultat(original.getId());
        Optional<BeregningsresultatEntitet> revurderingResultat = beregningsresultatRepository.hentEndeligBeregningsresultat(revurdering.getId());
