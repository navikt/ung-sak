...
class ProsessTriggereRepositoryTest {
    ...
    void skal_kunne_diffe_grunnlag() {
        ...
        var etter = new ProsessTriggere(new Triggere(Set.of(new Trigger(BehandlingÅrsakType.NY_SØKT_PERIODE, DatoIntervallEntitet.fraOgMedTilOgMed(LocalDate.now(), LocalDate.now().plusDays(2))))));
