...
@Immutable
@Entity(name = "AktivitetsvilkårResultatPeriode")
@Table(name = "aktivitet_resultat_periode")
public class AktivitetsvilkårResultatPeriode extends BaseEntitet {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_AKTIVITET_RESULTAT_PERIODE")
    @SequenceGenerator(name = "SEQ_AKTIVITET_RESULTAT_PERIODE", sequenceName = "seq_aktivitet_resultat_periode", allocationSize = 50)
    private Long id;
