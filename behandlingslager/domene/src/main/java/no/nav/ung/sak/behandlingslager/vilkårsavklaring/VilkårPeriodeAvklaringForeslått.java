...
/**
 * Vilkårsavklaring som er foreslått og behandlet i behandlingen som eier grunnlaget. Kopieres aldri videre til
 * en ny behandling — se {@link VilkårsavklaringGrunnlag}.
 */
@Entity(name = "VilkårPeriodeAvklaringForeslått")
@Table(name = "VILKAAR_PERIODE_AVKLARING_FORESLAATT")
@Immutable
public class VilkårPeriodeAvklaringForeslått extends BaseEntitet implements VilkårPeriodeAvklaring {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_VILKAAR_PERIODE_AVKLARING_FORES")
    private Long id;
    ...
    public VilkårPeriodeAvklaringForeslått() {
        // Hibernate
    }
    ...
    public VilkårPeriodeAvklaringForeslått(DatoIntervallEntitet periode,
        ...
        Objects.requireNonNull(ikkeOppfyltÅrsakKode, "Mangler årsak for hvorfor vilkåret ikke er oppfylt");
    ...
    public VilkårPeriodeAvklaringForeslått(VilkårPeriodeAvklaringForeslått annenAvklaring) {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof VilkårPeriodeAvklaringForeslått that)) return false;
