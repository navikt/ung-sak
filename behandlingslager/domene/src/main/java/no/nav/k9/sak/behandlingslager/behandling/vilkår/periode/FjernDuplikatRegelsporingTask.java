...
public class FjernDuplikatRegelsporingTask implements ProsessTaskHandler {
    ...
    public void doTask(ProsessTaskData prosessTaskData) {
        ...
        var query = entityManager.createNativeQuery(
            "select id from vr_vilkar_periode where regel_evaluering is not null and regel_evaluering::oid != regel_evaluering_oid SKIP LOCKED limit :antall"
        ...
        var regelInputQuery = entityManager.createNativeQuery(
            "select id from vr_vilkar_periode where regel_input is not null and regel_input::oid != regel_input_oid SKIP LOCKED limit :antall"
        ).setParameter("antall", maksAntallPerioder);
