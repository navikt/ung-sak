...
public class InntektskategoriKlassekodeMapper {
    ...
    public static String mapTilKlassekode(Inntektskategori inntektskategori, ØkonomiYtelseType økonomiYtelseType) {
        var map = getMap(økonomiYtelseType);
    ...
    private static Map<Inntektskategori, ØkonomiKodeKlassifik> getMap(ØkonomiYtelseType type) {
        switch (type) {
            case FØDSEL:
