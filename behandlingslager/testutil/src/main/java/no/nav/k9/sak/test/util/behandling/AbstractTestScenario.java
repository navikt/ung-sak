...
import no.nav.k9.sak.behandlingslager.behandling.medlemskap.MedlemskapRegistrertEntitet;
...
import no.nav.k9.sak.behandlingslager.behandling.vilkår.VilkårsResultat;
        ...
        if (personer != null && !personer.isEmpty()) {
            ...
            PersonInformasjon registerInformasjon = PersonInformasjon.builder(PersonopplysningVersjonType.REGISTRERT)
                .leggTilPersonopplysninger(
                    no.nav.k9.sak.test.util.behandling.personopplysning.Personopplysning.builder()
