...
public class RegisterdataInnhentingTest {
    ...
    void skal_hente_StartpunktUtleder_for_PersonInformasjon() throws Exception {
        var utlederOpt = EndringStartpunktUtleder.finnUtleder(CDI.current().select(EndringStartpunktUtleder.class), PersonInformasjonEntitet.class, FagsakYtelseType.OMSORGSPENGER_KS);
    ...
    void skal_hente_BehandlingÅrsakUtleder_for_PersonInformasjon() throws Exception {
        var utlederOpt = BehandlingÅrsakUtleder.finnUtleder(CDI.current().select(BehandlingÅrsakUtleder.class), PersonInformasjonEntitet.class, FagsakYtelseType.OMSORGSPENGER_KS);
