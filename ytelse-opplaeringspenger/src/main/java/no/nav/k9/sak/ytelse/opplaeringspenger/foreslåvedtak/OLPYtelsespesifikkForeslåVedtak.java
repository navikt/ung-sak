...
public class OLPYtelsespesifikkForeslåVedtak implements YtelsespesifikkForeslåVedtak {
    ...
    @Inject
    public OLPYtelsespesifikkForeslåVedtak(SamtidigUttakTjeneste samtidigUttakTjeneste, BehandlingProsesseringTjeneste behandlingProsesseringTjeneste, BehandlingRepository behandlingRepository) {
