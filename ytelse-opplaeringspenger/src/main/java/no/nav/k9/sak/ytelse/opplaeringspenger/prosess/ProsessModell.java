...
public class ProsessModell {
    ...
    public BehandlingModell førstegangsbehandling() {
        ...
        modellBuilder
            ...
            .medSteg(BehandlingStegType.VURDER_INSTITUSJON_VILKÅR)
            .medSteg(BehandlingStegType.VURDER_MEDISINSKE_VILKÅR, StartpunktType.INNGANGSVILKÅR_MEDISINSK)
            .medSteg(BehandlingStegType.VURDER_GJENNOMGÅTT_OPPLÆRING)
            ...
            .medSteg(BehandlingStegType.VURDER_STARTDATO_UTTAKSREGLER)
