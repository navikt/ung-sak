...
public class VurdertOpplæringPeriode extends BaseEntitet {
    ...
    public VurdertOpplæringPeriode(DatoIntervallEntitet periode, String begrunnelse) {
        this.periode = periode;
        this.begrunnelse = begrunnelse;
    }

    public VurdertOpplæringPeriode(LocalDate fom, LocalDate tom, String begrunnelse) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(periode, begrunnelse);
    }
}
